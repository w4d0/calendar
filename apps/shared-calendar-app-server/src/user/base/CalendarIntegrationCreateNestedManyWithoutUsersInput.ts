...
@InputType()
class CalendarIntegrationCreateNestedManyWithoutUsersInput {
...
export { CalendarIntegrationCreateNestedManyWithoutUsersInput as CalendarIntegrationCreateNestedManyWithoutUsersInput };
